...
import type { LeaderboardDetail, LeaderboardRow } from "@bootcamp/shared/types";
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="card divide-y divide-gray-200">
        ...
        {rows.length === 0 ? <p className="p-4 text-sm text-gray-500">No leaderboard data yet.</p> : null}
      </section>
    </div>
  );
}
